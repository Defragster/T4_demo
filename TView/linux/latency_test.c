...
gettimeofday_(struct timeval * tp, struct timezone * tzp)
{
    ...
    // Paul says to use : GetSystemTimePreciseAsFileTime 
    // https://forum.pjrc.com/threads/54711-Teensy-4-0-First-Beta-Test?p=204729&viewfull=1#post204729
//VOID (*WINAPI myGetSystemTime)(LPFILETIME);
//    GetSystemTimePreciseAsFileTime( &file_time ); // out ft); // NEW
